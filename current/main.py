...
for num in range(0,16):
    ...
    for epoch in range(epochs):
        ...
        # continuity = ransUtils.continuity(x,y,pred_Ux, pred_Uy)
        # momentum_u = ransUtils.momentum_u(x,y,pred_Ux, pred_Uy, 1, pred_p, viscosity, pred_Rx, pred_Rxy)
        # momentum_v = ransUtils.momentum_v(x,y,pred_Ux, pred_Uy, 1, pred_p, viscosity, pred_Ry, pred_Rxy)
        # pinn_loss = (continuity + momentum_u + momentum_v) * 0.01
        total_loss = loss #+ pinn_loss
        total_loss.backward()
        optimizer.step()
